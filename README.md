...
Build a document understanding pipeline using PaddleOCR-VL for:

1. Raw OCR / Markdown extraction
2. Schema-driven document field extraction
3. Provenance of extracted information
...
PaddleOCR-VL
    ↓
Raw Markdown + Layout Information
    ↓
Schema-Driven Extraction
    ↓
Structured JSON
    ↓
Provenance with Bounding Box
...

{
  "total_amount": {
    ...
    "provenance": {
      "page": 1,
      "source_text": "Total Amount: 52000",
      "bbox": [78, 640, 346, 669]
    }
  }
}
...
First run PaddleOCR-VL on the input document and generate the output files.
...
Raw Markdown Extraction: Completed

Schema-Driven Extraction: Completed

Basic Provenance: Completed

Bounding-Box Provenance: Implemented
